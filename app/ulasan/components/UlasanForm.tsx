    ...
    return (
      <div className="text-center py-6">
        ...
        <p className="text-gray-400">
          Ulasan Anda sangat berharga bagi kami untuk terus meningkatkan layanan.
        </p>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-secondary/50 border border-primary/30 rounded-md py-2 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
          >
            <option value="">Pilih Game (Opsional)</option>
            {games.map((game) => (
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Bagaimana pengalaman Anda dengan MoraStore?"
            rows={4}
            className="w-full bg-secondary/50 border border-primary/30 rounded-md py-2 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary placeholder-gray-600"
          />
        </div>
